...
const resources = {
  en: {
    translation: {
      ...
      'Each quarter will unlock 2,500,000 SATA tokens for use by Congruent Labs in marketing, development & additional':'Each quarter will unlock 2,500,000 SATA tokens for use by Congruent Labs in marketing, development & additional business activities where required. This supply is expected to be completely unlocked by Q1 2025.',
      ...
      '10,000,000 tokens will be locked. In Q3 2021 5,000,000 tokens will be released in conjunction with the release of the':'10,000,000 tokens will be locked. In Q3 2021 5,000,000 tokens will be released in conjunction with the release of the proof of concepts. In Q4 2021 the remaining 5,000,000 tokens will be released for further proof of concept releases.',
      'Undistributed Tokens':'Undistributed Tokens',
      '35,000,000 tokens will remain unlocked and are intented to be moved':'35,000,000 tokens will remain unlocked and are intented to be moved into market liquidity by Q4 2021, in the form of exchange listings, airdrops, and OTC investments. As third parties are unpredictable with their integration timelines, the actual amount to be added as circulating supply will may be delayed, and may only enter the market at a later point in the schedule.',
  ...
  es: {
    translation: {
      ...
      '10,000,000 tokens will be locked. In Q3 2021 5,000,000 tokens will be released in conjunction with the release of the':'Un total de 10,000,000 serán bloqueados. En el T3 del 2021, se desbloquearán 5,000,000 en conjunto con el lanzamiento de las pruebas de concepto. En el T4 del 2021, los 5,000,000 tokens restantes se desbloquearán para las pruebas de concepto futuras.',

...
const resources = {
  ...
  es: {
    translation: {
      ...
      'Privacy': 'Privacidad',
      'Identity': 'Identidad',
      'subtitle': 'Signata, SATA, y el Framework de Protección de Identidad y la Anonimidad (IdGAF en inglés).',
      ...
      'Use Signata to store': 'Utiliza Signata para y manejar tus claves de las criptomonedas dentro de dispositivos de hardware asequibles.',
